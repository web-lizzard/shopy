...
def downgrade() -> None:
    ...
    op.create_table('products_in_carts',
    sa.Column('quantity', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('product_id', sa.VARCHAR(length=60), autoincrement=False, nullable=False),
    sa.Column('id', sa.VARCHAR(length=60), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['product_id'], ['products.id'], name='products_in_carts_product_id_fkey'),
